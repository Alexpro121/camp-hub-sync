...
const CHILD_STEPS = [
  { 
    Icon: ShoppingBag, 
    text: "Обирай товари або смаколики на ярмаркових наметах Проєкту." 
  },
  {
    Icon: Send,
...
const TIP = {
  ...
  supervisor:
    "Ви можете увімкнути перемикач «Дозволити покупки іншим командам», щоб приймати оплату від усіх Учасників зміни.",
};
